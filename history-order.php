...
// Get customer's historical orders (completed + rejected)
$orders = $order->getOrderHistoryByCustomer($userId);

// Count history orders by status
$statusCounts = [
  'completed' => 0,
  'rejected' => 0
];
    ...
    <div class="orders-table-container">
      ...
      <?php if (empty($orders)): ?>
        <div class="empty-orders">
          ...
          <p>You don't have any completed or rejected orders yet.</p>
